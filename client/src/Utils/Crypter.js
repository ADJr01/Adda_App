...
export const hash_sha56 = pas => createHash('sha256').update(pas).digest('hex');
export const hash_MD5 = pas => createHash('md5').update(pas).digest('hex');
const textVerse = _ => {
    const deverse = str => {
...
export const encodetoVersed = req => {
...
export const decodeFromVersed = encoded => {
